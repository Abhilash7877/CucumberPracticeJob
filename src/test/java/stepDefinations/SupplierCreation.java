...
public void wait_For_Supplier() throws Throwable {
    FunctionLibrary.waitForElement(driver, "xpath", "//li[@id='mi_a_suppliers']//a[contains(text(),'Suppliers')]", "10");
}
...
public void wait_For_AddButton() throws Throwable {
    FunctionLibrary.waitForElement(driver, "xpath", "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/a[1]", "10");
}

@When("^Click On AddButton$")
public void click_On_AddButton() throws Throwable {
    FunctionLibrary.clickAction(driver, "xpath", "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/a[1]");
}

@When("^Wait For SupplierNumber$")
public void wait_For_SupplierNumber() throws Throwable {
    FunctionLibrary.waitForElement(driver, "id", "x_Supplier_Number", "10");
}
...
public void wait_For_Alert() throws Throwable {
  FunctionLibrary.waitForElement(driver, "xpath", "(//button[text()='OK'])[6]", "10");
}

@When("^Click On Alert$")
public void click_On_Alert() throws Throwable {
  FunctionLibrary.clickAction(driver, "xpath", "(//button[text()='OK'])[6]");
}
